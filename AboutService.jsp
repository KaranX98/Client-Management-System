...
<TABLE class=tabformat cellSpacing=1 cellPadding=2 width="100%" border=0 >
  ...
  <TR>
    ...
    <TD class=tabhead width="10%"><a href="ServiceDetails.jsp">About Service</a></TD>
    <TD class=tabhead width="10%"><a href="AdminLogin.jsp">Customer Login</a></TD>
    <TD class=tabhead width="10%"><a href="ShowTemplates.jsp">Templates</a></TD>
    
    <TD class=tabhead width="10%"><a href="AboutUs.jsp">About Us</a></TD>
    <TD class=tabhead width="10%"><a href="ContactUs.jsp">Contact Us</a></TD>

  </TBODY></TABLE>
<TABLE class=tabformat cellSpacing=1 cellPadding=2 width="100%" border=0>
  <TBODY>
  <TR>
  <TD><b><a href="ViewServiceDetails.jsp" class=caption2 >View All Service Details</a></b></td>
  
  <TD><b><a href="NewService.jsp" class=caption2 >New Service</a></b></td>
  </TR>
