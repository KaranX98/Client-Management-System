...
<TABLE class=tabformat cellSpacing=1 cellPadding=2 width="100%" border=0>
  ...
  <TD><b><a href="DomainDetails.jsp" class=caption2 >Domain Details</a></b></td>
  <TD><b><a href="GetDomainFees.jsp" class=caption2 >Membership Fee Details</a></b></td>
  <TD><b><a href="InsertDomainFeeDetails.jsp" class=caption2 >New Membership Fee </a></b></td>
  </TR>
</TBODY></TABLE>
<br>
<br>
